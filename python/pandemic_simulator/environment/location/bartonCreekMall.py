...
__all__ = ['BartonCreekMall', 'MallState']


@dataclass
class MallState(NonEssentialBusinessLocationState):
...
class BartonCreekMall(NonEssentialBusinessBaseLocation[MallState]):
    """Implements a hair salon."""
    state_type = MallState
